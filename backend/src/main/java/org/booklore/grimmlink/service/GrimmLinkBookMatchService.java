...
/**
 * Adapter service for GrimmLink book matching.
 * <p>
 * All GrimmLink code should go through this service for book-by-hash resolution,
 * rather than calling {@link BookRepository} directly. This keeps fork-specific
 * hash lookup logic out of upstream hotspot files.
 */
@Slf4j
@Service
@RequiredArgsConstructor
public class GrimmLinkBookMatchService {
    ...
    public BookEntity resolveAccessibleBookByHash(BookLoreUserEntity reader, String bookHash) {
        // 1. Try currentHash first (upstream method kept in BookRepository)
        ...
        // 2. Fallback to initialHash among candidates (fork-specific lookup)
